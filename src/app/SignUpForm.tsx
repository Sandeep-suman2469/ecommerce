        ...
        <div className="bg-gray-100  w-full h-screen border-2  flex items-center justify-center">
           <div className=" flex flex-col  bg-white items-center justify-center text-center text-black rounded-[17px] w-[651px] ">
              ...
              <form className="flex flex-col w-[419.69px] px-5">
                <input type="text" placeholder="Enter your name" className="border-b-2 border-gray-400 py-2 placeholder:text-black mb-4 focus:outline-none"/>
                ...
                <input type="password" placeholder="Confirm password"className="border-b-2 border-gray-400  placeholder:text-black py-2 mb-4 focus:outline-none"/>
                <button className="text-white bg-[rgb(45,32,28)] w-[147px] mx-auto py-2 rounded-4xl flex items-center justify-center mt-8 mb-6 ">SIGN UP</button>
              </form>
